...
(cl:defmethod cl:initialize-instance :after ((m <GNSSDualAntennaStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GNSSDualAntennaStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mscl_msgs-msg:<GNSSDualAntennaStatus> is deprecated: use mscl_msgs-msg:GNSSDualAntennaStatus instead.")))
...
(cl:defmethod heading-val ((m <GNSSDualAntennaStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:heading-val is deprecated.  Use mscl_msgs-msg:heading instead.")
  (heading m))
...
(cl:defmethod fix_type-val ((m <GNSSDualAntennaStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:fix_type-val is deprecated.  Use mscl_msgs-msg:fix_type instead.")
  (fix_type m))

(cl:ensure-generic-function 'rcv_1_valid-val :lambda-list '(m))
(cl:defmethod rcv_1_valid-val ((m <GNSSDualAntennaStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:rcv_1_valid-val is deprecated.  Use mscl_msgs-msg:rcv_1_valid instead.")
  (rcv_1_valid m))

(cl:ensure-generic-function 'rcv_2_valid-val :lambda-list '(m))
(cl:defmethod rcv_2_valid-val ((m <GNSSDualAntennaStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:rcv_2_valid-val is deprecated.  Use mscl_msgs-msg:rcv_2_valid instead.")
  (rcv_2_valid m))
...
(cl:defmethod antenna_offsets_valid-val ((m <GNSSDualAntennaStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscl_msgs-msg:antenna_offsets_valid-val is deprecated.  Use mscl_msgs-msg:antenna_offsets_valid instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GNSSDualAntennaStatus>)))
  ...
  "mscl_msgs/GNSSDualAntennaStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GNSSDualAntennaStatus)))
  "Returns string type for a message object of type 'GNSSDualAntennaStatus"
  "mscl_msgs/GNSSDualAntennaStatus")
